...
import DishCard from "../../common/DishCard"; // DishCard for dish display
...
const RestaurantDetail = ({restoId}) => {
    ...
    <div className="">
      ...
      <div className="mx-10 lg:ml-30 lg:mr-20 ">
        {categories.map((category) => {
          ...
          if (!prevRefs.current[category._id]) prevRefs.current[category._id] = React.createRef();
          if (!nextRefs.current[category._id]) nextRefs.current[category._id] = React.createRef();
          ...
          return (
            <div key={category._id} className="relative">
              ...
              <Swiper
                ...
                onBeforeInit={(swiper) => {
                  swiper.params.navigation.prevEl = prevRefs.current[category._id].current;
                  swiper.params.navigation.nextEl = nextRefs.current[category._id].current;
                }}
                breakpoints={{
                  1:{slidesPerView:1},
                  640: { slidesPerView: 2 },
